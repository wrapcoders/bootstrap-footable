	...
	F.Filtering = F.Component.extend(
		/** @lends FooTable.Filtering */ {
			...
			$create: function () {
				...
				var $form_grp = $("<div/>", { class: "form-group footable-filtering-search" }) /* .append($("<label/>", { class: "sr-only", text: "Search" })) */,
					$input_grp = $("<div/>", { class: "input-group" }).appendTo($form_grp),
					$input_grp_btn = $("<div/>", { class: "input-group" }),
					$dropdown_toggle = $("<button/>", { type: "button", "data-bs-toggle": "dropdown", "data-bs-auto-close": "outside", class: "btn btn-light dropdown-toggle px-3 dropdown-toggle" })
				...
				self.$form = $("<form/>", { class: "d-sm-flex align-items-center justify-content-between" }).append($form_grp).appendTo(self.$container);

				self.$input = $("<input/>", { type: "text", class: "form-control", placeholder: self.placeholder });

				self.$button = $("<button/>", { type: "button", class: "btn btn-light rounded-0 px-3" })
				...
				self.$dropdown.append(
					F.arr.map(self.ft.columns.array, function (col) {
						return col.filterable ? $("<li/>").append($("<a/>", { class: "form-check dropdown-item" }).append($("<label/>", { class: "form-check-label w-100 d-block ms-4", html: col.title }).prepend($("<input/>", { class: "form-check-input", type: "checkbox", checked: true }).data("__FooTableColumn__", col)))) : null;
					})
				);
				...
				var self = this,
					...
					link = function (attr, html, klass) {
						return $("<li/>", {
							...
							.append(
								$("<a/>", {
									class: "footable-page-link btn btn-light btn-icon btn-md",
...
(function ($, F) {
	F.Editing = F.Component.extend(
		/** @lends FooTable.Editing */ {
			 ...
			 */
			$buttonHide: function () {
				return '<button type="button" class="btn btn-soft-danger footable-hide">' + this.hideText + "</button>";
			},
			/**
			...
			$buttonDelete: function () {
				return '<button type="button" class="btn btn-light footable-delete">' + this.deleteText + "</button>";
			},
			/**
			 ...
			 */
			$buttonView: function () {
				return '<button type="button" class="btn btn-light footable-view">' + this.viewText + "</button> ";
			},
			/**
...
(function ($, F) {
	...
	F.Defaults.prototype.editing = {
		...
		showText: '<span class="fooicon fooicon-pencil me-2" aria-hidden="true"></span> Edit Rows',
		hideText: "Cancel",
		addText: '<span class="fooicon fooicon-plus me-2" aria-hidden="true"></span> Add New Row',
